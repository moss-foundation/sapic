...
export const USE_BATCH_UPDATE_TREE_ITEM_STATE_MUTATION_KEY = "batchUpdateTreeItemState";

export const useBatchUpdateTreeItemState = () => {
  const queryClient = useQueryClient();
  return useMutation<void, Error, { treeItemStates: TreeItemState[]; workspaceId: string }>({
    mutationKey: [USE_BATCH_UPDATE_TREE_ITEM_STATE_MUTATION_KEY],
