...
export const USE_BATCH_UPDATE_ENVIRONMENT_LIST_ITEM_STATE_MUTATION_KEY = "batchUpdateEnvironmentListItemState" as const;

export const useBatchUpdateEnvironmentListItemState = () => {
  const queryClient = useQueryClient();
  return useMutation<void, Error, { environmentListItemStates: EnvironmentListItemState[]; workspaceId: string }>({
    mutationKey: [USE_BATCH_UPDATE_ENVIRONMENT_LIST_ITEM_STATE_MUTATION_KEY],
