...
const Trigger = forwardRef<HTMLDivElement, Menu.ActionMenuTriggerProps>(({ children, className, ...props }, ref) => {
  return (
    <Menu.Trigger
      ref={ref}
      className={cn(
        "hover:background-(--moss-controls-background-hover) background-(--moss-controls-background) border-(--moss-controls-border) p-1.25 cursor-pointer rounded-md border",
        className
      )}
      {...props}
    >
...
const Content = forwardRef<HTMLDivElement, Menu.ContentProps>(({ children, className, ...props }, ref) => {
  return (
    <Menu.Content
      ref={ref}
      className={cn(
        "background-(--moss-controls-background) border-(--moss-controls-border) p-1.25 rounded-md border",
        className
      )}
      {...props}
    >
