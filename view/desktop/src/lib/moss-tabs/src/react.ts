...
export class ReactPart<P extends object, C extends object = {}> implements IFrameworkPart {
  ...
  private createPortal() {
    ...
    const bridgeComponent = React.createElement(React.forwardRef(ReactComponentBridge), {
      component: this.component as unknown as React.FunctionComponent<{}>,
...
export function isReactComponent(component: any): boolean {
  ...
  return (
    ...
    !!(component as React.ExoticComponent)?.$$typeof /** React.memo(...) Components */
  );
}
