...
export abstract class GridviewPanel<T extends GridviewPanelApiImpl = GridviewPanelApiImpl>
  ...
  implements IGridPanelComponentView, IGridviewPanel
{
  ...
  toJSON(): GridPanelViewState {
    ...
    const maximum = (value: number) => (value === Number.MAX_SAFE_INTEGER ? undefined : value);
