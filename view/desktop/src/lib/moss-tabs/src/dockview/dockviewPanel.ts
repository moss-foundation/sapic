...
export class DockviewPanel extends CompositeDisposable implements IDockviewPanel {
  ...
  public updateParentGroup(group: DockviewGroupPanel, options?: { skipSetActive?: boolean }): void {
    this._group = group;
