  ...
  return (
    <li>
      <button
        ...
        className="hover:background-(--moss-secondary-background-hover) relative flex w-full min-w-64 cursor-pointer items-center gap-1 py-0.5 dark:hover:text-black"
      >
