...
export const useNodeDragAndDropHandler = () => {
  ...
  const handleCombineWithinCollection = async (sourceTreeNodeData: DragNode, locationTreeNodeData: DropNode) => {
  ...
  const handleReorderWithinCollection = async (
    sourceTreeNodeData: DragNode,
  ...
  const handleMoveToAnotherCollection = async (
    sourceTreeNodeData: DragNode,
    locationTreeNodeData: DropNode,
    operation: "reorder-before" | "reorder-after" | "combine"
  ) => {
