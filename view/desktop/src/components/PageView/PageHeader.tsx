...
export const PageHeader: React.FC<PageHeaderProps> = ({ title, icon, tabs, toolbar, className }) => {
  return (
    <header
      className={cn("h-9 border-b border-gray-200 bg-gray-50 dark:border-stone-800 dark:bg-stone-900", className)}
    >
      ...
      <div className="flex h-full items-center px-4">
        ...
        <div className="flex min-w-0 flex-shrink-0 items-center gap-1.5">
          ...
          <h1 className="truncate text-[16px] font-semibold text-gray-900 dark:text-white">{title}</h1>
        </div>
