          ...
          {isRenamingTitle ? (
            ...
            >
              <Input
                ...
                className="w-full rounded-xs py-0 text-[16px] leading-6 font-semibold text-(--moss-primary-foreground) has-[input:focus-within]:outline-offset-1"
            ...
            <button
              ...
              className={cn(
                "-mx-1 truncate overflow-hidden rounded px-1 text-left text-[16px] leading-6 font-semibold text-(--moss-primary-foreground)",
                {
