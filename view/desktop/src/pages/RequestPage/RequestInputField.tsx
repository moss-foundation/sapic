...
export const RequestInputField: React.FC<RequestInputFieldProps> = ({
  ...
  const handleTemplateChange = (value: string, variables: string[]) => {
    setUrl(value);
  };
    ...
    <div className={cn("flex w-full items-center gap-2", className)}>
      ...
      <div className="relative">
        <button
          ...
          className={cn(
            "flex items-center gap-1 rounded-sm px-3 py-1.5 text-sm font-medium transition-colors",
            "border border-gray-200 bg-gray-100 text-orange-600 hover:bg-gray-200",
      ...
      <button
        onClick={handleSend}
        className={cn(
          "rounded-sm bg-blue-600 px-4 py-2 text-sm font-medium text-white hover:bg-blue-700",
