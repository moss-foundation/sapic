...
const SvgOpenWorkspaceActive: React.FC<SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="none" {...props}>
    <path
      ...
      className="fill-[var(--moss-blue-12)] stroke-[var(--moss-blue-4)] dark:fill-[var(--moss-gray-4)] dark:stroke-[var(--moss-icon-primary-background-active)]"
    />
  </svg>
);
export default SvgOpenWorkspaceActive;
