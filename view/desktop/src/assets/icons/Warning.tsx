...
const SvgWarning: React.FC<SVGProps<SVGSVGElement>> = (props) => (
  <div {...props}>
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" className="block dark:hidden">
      <path
        d="M1.27603 10.8634 6.3028 1.98903c.74697-1.318707 2.64613-1.318704 3.39309 0l5.02681 8.87437C15.516 12.2639 14.5047 14 12.8956 14H3.10308C1.494 14 .482737 12.2639 1.27603 10.8634Z"
        fillRule="evenodd"
        clipRule="evenodd"
        className="fill-[var(--moss-yellow-4)]"
      />
      <path
        d="M9 5c0-.55228-.44772-1-1-1s-1 .44772-1 1v2.5c0 .55229.44772 1 1 1 .55229 0 1-.44772 1-1V5ZM8 12c.55228 0 1-.4477 1-1s-.44772-1-1-1-1 .4477-1 1 .44772 1 1 1Z"
        className="fill-[var(--moss-gray-14)]"
      />
    </svg>
