...
const SvgFolder: React.FC<SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="none" {...props}>
    <path
      ...
      className="fill-[var(--moss-gray-12)] stroke-[var(--moss-gray-6)] dark:fill-[var(--moss-gray-4)] dark:stroke-[var(--moss-gray-11)]"
    />
  </svg>
);
