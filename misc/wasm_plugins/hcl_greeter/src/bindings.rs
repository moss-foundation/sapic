...
#[doc(hidden)]
macro_rules! __export_world_hcl_greeter_cabi {
...
#[doc(hidden)]
pub(crate) use __export_world_hcl_greeter_cabi;
#[repr(align(8))]
...
#[allow(unused_macros)]
#[doc(hidden)]
macro_rules! __export_hcl_greeter_impl {
    ($ty:ident) => {
        self::export!($ty with_types_in self);
    };
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*:: __export_world_hcl_greeter_cabi!($ty with_types_in
        $($path_to_types_root)*);
    };
}
#[doc(inline)]
pub(crate) use __export_hcl_greeter_impl as export;
#[cfg(target_arch = "wasm32")]
#[unsafe(link_section = "component-type:wit-bindgen:0.41.0:plugin:rust-hcl-greeter:hcl-greeter:encoded world")]
#[doc(hidden)]
...
\x04\0#plugin:rust-hcl-greeter/hcl-greeter\x04\0\x0b\x11\x01\0\x0bhcl-greeter\x03\
