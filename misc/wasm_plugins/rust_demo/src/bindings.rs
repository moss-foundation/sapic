...
#[doc(hidden)]
macro_rules! __export_world_rust_demo_cabi {
...
#[doc(hidden)]
pub(crate) use __export_world_rust_demo_cabi;
#[repr(align(8))]
...
#[allow(unused_macros)]
#[doc(hidden)]
macro_rules! __export_rust_demo_impl {
    ($ty:ident) => {
        self::export!($ty with_types_in self);
    };
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*:: __export_world_rust_demo_cabi!($ty with_types_in
        $($path_to_types_root)*);
    };
}
#[doc(inline)]
pub(crate) use __export_rust_demo_impl as export;
#[cfg(target_arch = "wasm32")]
#[unsafe(link_section = "component-type:wit-bindgen:0.41.0:plugin:rust-demo:rust-demo:encoded world")]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 479] = *b"\
...
\x04\0\x1aplugin:rust-demo/rust-demo\x04\0\x0b\x0f\x01\0\x09rust-demo\x03\0\0\0G\
