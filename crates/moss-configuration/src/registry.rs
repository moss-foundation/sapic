...
// use crate::{
//     contribution::{ConfigurationDecl, ParameterDecl, RegisterConfigurationContribution},
//     models::{
//         primitives::ConfigurationParameterType as ParameterType,
//         types::{ConfigurationSchema, ParameterSchema},
//     },
// };
...
// // pub struct GlobalConfigurationRegistry(Arc<dyn ConfigurationRegistry>);

// // impl dyn ConfigurationRegistry {
// //     pub fn global<R: AppRuntime>(delegate: &AppDelegate<R>) -> Arc<dyn ConfigurationRegistry> {
// //         delegate.global::<GlobalConfigurationRegistry>().0.clone()
// //     }

// //     pub fn set_global<R: AppRuntime>(delegate: &AppDelegate<R>, v: Arc<dyn ConfigurationRegistry>) {
// //         delegate.set_global(GlobalConfigurationRegistry(v));
// //     }
// // }
