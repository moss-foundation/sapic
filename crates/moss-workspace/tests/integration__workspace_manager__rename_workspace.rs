...
async fn rename_workspace_success() {
    ...
    assert_eq!(list_workspaces_output.0[0].path, expected_path.clone());
    assert_eq!(list_workspaces_output.0[0].name, new_workspace_name);
...
async fn rename_workspace_unchanged() {
    ...
    assert_eq!(workspaces_list.0[0].path, expected_path.clone());
    assert_eq!(workspaces_list.0[0].name, new_workspace_name);
