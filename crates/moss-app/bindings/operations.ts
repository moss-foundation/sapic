...
import type { GitProviderType, LogLevel } from "./primitives";
import type {
  ColorThemeInfo,
  Defaults,
  LocaleInfo,
 ...
 * @category Operation
 */
export type AddAccountInput = { gitProviderType: GitProviderType };

/**
 * @category Operation
 */
export type AddAccountOutput = { userInfo: UserInfo };
