...
import type { AccountKind, ConfigurationParameterType, ConfigurationTarget, LogLevel, ThemeMode } from "./primitives";
 ...
 * @category Type
 */
export type ConfigurationNodeSchema = {
  id: string;
  parentId?: string;
  order?: bigint;
  name?: string;
  description?: string;
  parameters: Array<ConfigurationParameterItemSchema>;
};

/**
 * @category Type
 */
export type ConfigurationParameterItemSchema = {
  id: string;
  default?: JsonValue;
