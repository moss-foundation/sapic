...
// use moss_theme::manifest::ThemeManifestFile;
// use std::path::Path;

// use crate::theme::{conversion::convert_theme_to_css, validation::validate_theme};
...
// //     themes_dir: &Path,
// // ) -> joinerror::Result<()> {
// //     let theme: ThemeManifestFile = serde_json::from_reader(std::fs::File::open(input_path)?)?;
