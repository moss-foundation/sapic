...
pub unsafe fn _export_execute_cabi<T: Guest>(
    ...
    match result30 {
        ...
        V44::Str(e) => {
            ...
            *ptr31.add(8 + 1 * ::core::mem::size_of::<*const u8>()).cast::<usize>() = len33;
        ...
        V44::Arr(e) => {
            ...
            *ptr31.add(8 + 1 * ::core::mem::size_of::<*const u8>()).cast::<usize>() = len37;
        ...
        V44::Obj(e) => {
            *ptr31.add(0).cast::<u8>() = (5i32) as u8;
            ...
            for (i, e) in vec43.into_iter().enumerate() {
                    ...
                    .add(i * (24 + 2 * ::core::mem::size_of::<*const u8>()));
                {
                    ...
                    *base.add(::core::mem::size_of::<*const u8>()).cast::<usize>() = len39;
            ...
            *ptr31.add(8 + 1 * ::core::mem::size_of::<*const u8>()).cast::<usize>() = len43;
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:plugin:base:plugin-world:encoded world"
)]
#[doc(hidden)]
...
\x04\0\x18plugin:base/plugin-world\x04\0\x0b\x12\x01\0\x0cplugin-world\x03\0\0\0\
