...
// use crate::{
//     WorkspaceStorage,
//     common::{ItemStore, Transactional},
// };

// const WORKSPACE_STATE_DB_NAME: &str = "state.db";

// pub(crate) type ItemStoreTable<'a> = BincodeTable<'a, String, AnyEntity>;
...
//     item_store: Arc<dyn ItemStore<String, AnyEntity>>,
// }
...
//             .with_table(&item_store::ITEM_STORE)?;
...
//         let item_store = Arc::new(ItemStoreImpl::new(
//             db_client.clone(),
