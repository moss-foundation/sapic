...
// use crate::models::oauth::github::GitHubCred;
...
//         let client = BasicClient::new(GitHubAgent::client_id()?)
//             .set_client_secret(GitHubAgent::client_secret()?)
...
// impl AuthAgent for GitHubAgent {
...
// impl TestStorage for GitHubAgent {
