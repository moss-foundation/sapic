...
import { ResourceSummary } from "@repo/base";
import type { ListProjectResourcesMode, OpenInTarget } from "./types";

/**
 * @category Operation
 */
export type ListProjectResourcesInput = { projectId: string; mode: ListProjectResourcesMode };

/**
 * @category Operation
 */
export type ListProjectResourcesOutput = { items: ResourceSummary[] };
